...
Thank you for connecting, Mikkel.
...
Built in days by me plus a system of AI agents I run. Your MCP server points the same direction: I would like to make IrisX the platform AI agents and ERPs default to. Glad to walk through any artifact, I am in Amsterdam.

Alexey

## Alternate greeting lines (fallback addressees)

- David Swan (SVP of Products): "Hi David, your roadmap sessions on the Marketplace prompted this..."
- Fred Rio (SVP Products and Pricing): "Hi Fred, credit consumption sits where pricing meets partnerships, which is exactly what I built a model for..."
