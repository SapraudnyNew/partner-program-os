...
- Two functions dominate and nothing else appears: business development (about half the list) and deployment strategists (the other half). Not a single title contains partnerships, alliances, channel or marketplace, which matches the job-board finding that no such roles are posted. Partner-shaped work at Palantir is done by BD and deployment people (inference).
- Tenures are strikingly short. Over half the list shows 5 months or less at the company, and 11 people show 1 to 2 months. Both the BD and deployment benches are being built out right now, consistent with the 85% revenue growth (inference).
